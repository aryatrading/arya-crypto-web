    ...
    const freePlan = useMemo(() => {
        return (
            <Col className="border-4 border-[#1F2F4D] rounded-2xl py-14 px-14 gap-5 relative">
                <Button disabled className="border border-[#1F2F4D] rounded-full py-1 px-5 w-fit">{t("Basic")}</Button>
        ...
        return (
            <Col className="border-4 border-blue-1 rounded-2xl py-14 px-14 gap-5 relative bg-[#152445]">
                ...
                <Col>
                    ...
                    <p className={clsx({ "opacity-0": paymentPeriod === EnumPricing.monthly }, "text-bold")}>{t("Billed")} <span className="text-blue-1">$179.88</span> {t("perYear")}</p>
                </Col>
    ...
    return (
        <Col className="py-20 w-full bg-[#111827] gap-14">
            <Col className="container items-center gap-14">
                ...
                <p className="text-center mt-5">{t("yourSubscriptionWillRenewAutomatically")}</p>
