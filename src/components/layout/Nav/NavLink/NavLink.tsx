...
const NavLink = ({ NavIcon, navTitle, Hover, active=false, className, ...props }: INavLink) => {
  ...
  return (
    <Link
      {...props}
      className= {twMerge("group flex justify-start items-center gap-3 lg:justify-center py-3 px-6 lg:p-0 lg:border-b-0",`${!!Hover&&'border-b-2 border-grey-3'}`,`${(!!Hover&&(isHover||active))&&'lg:border-b-2 lg:border-blue-1'}`,className)}
