    ...
    <Col className="w-full h-full pt-14 lg:pt-0">
      ...
      >
        <Col className="flex-1 w-full h-full gap-8 justify-center">
          <h2 className="font-bold text-white text-3xl md:text-5xl text-left md:leading-snug">
            <Trans
              i18nKey={t("salesPage.mainTitle")}
              components={{
                blueText: <span className="text-blue-1" />,
                curveText: <span className={styles.underlined} />,
              }}
            />
            <span className={styles.underlined}> {t("salesPage.results")}</span>
          </h2>
        ...
        <Col className="flex-1 w-full h-full gap-4 relative">
          <Lottie
            animationData={TradingImg}
            lottieRef={lottieRef}
            className={clsx(
              styles.animateImg,
              "w-full scale-125 md:scale-150 lg:scale-[1.65] absolute h-full"
            )}
          />
          <Lottie
            animationData={TradingImg}
            className={clsx("w-full scale-125 opacity-[0]")}
          />
        </Col>
      </Row>
      ...
      <Col className="w-full h-full items-center justify-center bg-[#111827] px-4">
        <Row className="gap-10 flex-col-reverse lg:flex-row items-center w-full lg:w-[100vw] px-4 lg:px-20 xl:px-72 py-14">
          <Col className="flex-1 w-full h-full gap-8 justify-center">
            <h2 className="font-bold text-white text-3xl md:text-5xl text-left md:leading-snug">
              {t("salesPage.protectCapital")}
            </h2>

            <p className="font-medium text-white text-left">
              {t("salesPage.protectCapitalDesc")}
            </p>
          ...
          <Col className="flex-1 w-full h-full gap-4">
            <Image
              alt=""
              src={require("../../../../public/assets/images/publicPages/trading/1.png")}
              className={clsx("w-full self-end h-full")}
            />
          </Col>
        </Row>
        ...
        <Row className="gap-10 flex-col lg:flex-row items-center w-full lg:w-[100vw] px-4 lg:px-20 xl:px-72 py-14 ">
          <Col className="flex-1 w-full h-full gap-4 items-center justify-center">
            <Image
              alt=""
              src={require("../../../../public/assets/images/publicPages/trading/2.png")}
              className={clsx("w-full self-end h-full")}
            />
          </Col>
          <Col className="flex-1 w-full h-full gap-8 justify-center">
            <h2 className="font-bold text-white text-3xl md:text-5xl text-left md:leading-snug">
              {t("salesPage.scheduleYourProfits")}
            </h2>

            <p className="font-medium text-white text-left">
              {t("salesPage.scheduleYourProfitsDesc")}
            </p>
        ...
        <Row className="gap-10 flex-col-reverse lg:flex-row items-center w-full lg:w-[100vw] px-4 lg:px-20 xl:px-72 py-14">
          <Col className="flex-1 w-full h-full gap-8 justify-center">
            <h2 className="font-bold text-white text-3xl md:text-5xl text-left md:leading-snug">
              {t("salesPage.avoidLoss")}
            </h2>

            <p className="font-medium text-white text-left">
              {t("salesPage.avoidLossDesc")}
            </p>
          ...
          <Col className="flex-1 w-full h-full gap-4">
            <Image
              alt=""
              src={require("../../../../public/assets/images/publicPages/trading/3.png")}
              className={clsx("w-full self-end h-full")}
            />
          </Col>
        </Row>
